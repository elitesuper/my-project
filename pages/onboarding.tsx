export default function Onboarding(){
    ...
    return(
        <>
            <main className="h-screen spectrum-background flex">
                <div className="w-5/6 max-w-5xl mx-auto">
                    <div className="w-full flex">
                        <div className="flex mx-auto my-10">
                            <img src="superwordicon.svg" className="my-auto mx-1"></img>
                            <p className="text-white text-2xl text-center font-bold mx-1">
                                Superword
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        <div className="subtitle mx-auto">
                            <p className="text-white text-center text-4xl pb-3">Works anywhere you work</p>
